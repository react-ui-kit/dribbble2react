          ...
          <View style={styles.section}>
            ...
            <View style={styles.group}>
              ...
              <TouchableOpacity
                style={[
                  styles.button,
                  activeType("tent") ? styles.active : null
                ]}
              ...
              >
                <Icon.Foundation
                  name="mountains"
                  size={24}
                  color={activeType("tent") ? "#FFF" : "#FF7657"}
                />
                <Text
                  style={[
                    styles.buttonText,
                    activeType("tent") ? styles.activeText : null
                  ]}
                >
                  Tenting
                </Text>
            ...
            <View>
              <View style={styles.option}>
                ...
                <Switch
                  ...
                  onValueChange={() =>
                    this.props.setFilters({ option_full: !option_full })
                  }
                />
              </View>
              <View style={styles.option}>
                ...
                <Switch
                  ...
                  trackColor={{ false: "#EAEAED", true: "#FF7657" }}
                  onValueChange={() =>
                    this.props.setFilters({ option_rated: !option_rated })
                  }
                />
              </View>
              <View style={styles.option}>
                ...
                <Switch
                  ...
                  trackColor={{ false: "#EAEAED", true: "#FF7657" }}
                  onValueChange={() =>
                    this.props.setFilters({ option_free: !option_free })
                  }
                />
              </View>
            </View>
